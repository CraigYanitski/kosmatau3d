class Observations():
  ...
  # PUBLIC
  def clumpMassProfile(self, file=directory+'mass_profile.dat'):
  ...
  def interclumpMassProfile(self, file=directory+'mass_profile_inter.dat'):
  ...
  def densityProfile(self, file=directory+'density_profile.dat'):
  ...
  def FUVfield(self, file=directory+'galactic_fuv.dat'):
  ...
  def rotationProfile(self, file=directory+'rot_milki2018_14.dat'):
