...
x_length = 3 # edge length of map (projection)
...
_globals['compound']['los_start'] =  np.array([0, 0, -2], int)
_globals['compound']['los_end']   =  np.array([0, 0, 5], int)
...
_globals['plots']['plotrange'] = np.array([[-2, 10], [-5, 5], [-2, 5]])
