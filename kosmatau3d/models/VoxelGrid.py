...
#         return self.__voxelFUVabsorption
    ...
    def shdu_header(self, name='', units='', molecules=False, dust=False, velocity=False, 
        ...
        header['COMMENT'] = ''.ljust(50)
        header['COMMENT'] = constants.history.ljust(50)
        header['COMMENT'] = ''.ljust(50)
        header['COMMENT'] = ''.ljust(50)
        header['COMMENT'] = 'Grid files'.ljust(50)
        header['COMMENT'] = ''.ljust(50)
        header['COMMENT'] = constants.tb_grid_file.ljust(50)
        header['COMMENT'] = constants.tau_grid_file.ljust(50)
        header['COMMENT'] = constants.tau_fuv_grid_file.ljust(50)
        header['COMMENT'] = ''.ljust(50)
        header['COMMENT'] = 'Input files'.ljust(50)
        header['COMMENT'] = ''.ljust(50)
        header['COMMENT'] = constants.h2_mass_file.ljust(50)
        header['COMMENT'] = constants.hi_mass_file.ljust(50)
        header['COMMENT'] = ' same as h2: {}'.format(constants.hi_mass_file).ljust(50)
        header['COMMENT'] = constants.density_file.ljust(50)
        header['COMMENT'] = constants.fuv_file.ljust(50)
        header['COMMENT'] = '  average spectrum: {}'.format(constants.average_fuv).ljust(50)
        header['COMMENT'] = '  integration range: {}'.format(constants.l_range).ljust(50)
        header['COMMENT'] = constants.velocity_file.ljust(50)
        header['COMMENT'] = ''.ljust(50)
        header['COMMENT'] = 'improved calculation: {}'.format(self.suggested_calc).ljust(50)
        header['COMMENT'] = ''.ljust(50)
        header['COMMENT'] = ''.ljust(50)
