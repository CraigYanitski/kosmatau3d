...
dustNames = np.array(['3.1mm', '2.4mm', '1.8mm', '1.3mm', '1.0mm', '850um', '700um', '550um', '420um', '300um', '240um', '188.4um', '177.8um', '167.9um', '158.5um', '149.6um', \
                      ...
                      '22.96um', '22.54um', '22.14um', '21.75um', '21.38um', '21.01um', '20.66um', '20.32um', '20.um', '19.68um', '19.37um', '19.07um', '18.79um', '18.5', '18.23um', '17.97um', \
                      '17.71um', '17.46um', '17.22um', '16.98um', '16.75um', '16.53um', '16.31um', '16.1um', '15.89um', '15.69um', '15.5um', '15.31um', '15.12um', '14.94um', '14.42um', '13.93um', \
                      '13.78um', '13.62um', '13.48um', '13.33um', '13.19um', '13.05um', '12.91um', '12.78um', '12.65um', '12.52um', '12.4um', '12.28um', '12.15um', '12.04um', '11.92um', '11.81um', \
                      '11.7um', '11.59um', '11.48um', '11.37um', '11.27um', '11.17um', '11.07um', '10.97um', '10.88um', '10.78um', '10.69um', '10.6um', '10.51um', '10.42um', '10.33um', '10.16um', \
                      '10.08um', '9.998um', '9.918um', '9.84um', '9.762um', '9.686um', '9.611um', '9.537um', '9.464um', '9.392um', '9.322um', '9.252um', '9.184um', '9.116um', '9.05um', '8.984um', \
                      '8.919um', '8.856um', '8.793um', '8.731um', '8.67um', '8.61um', '8.55um', '8.492um', '8.434um', '8.377um', '8.321um', '8.265um', '8.211um', '8.157um', '8.103um', '8.051um', \
                      '7.999um', '7.947um', '7.897um', '7.847um', '7.797um', '7.749um', '7.701um', '7.653um', '7.606um', '7.56um', '7.514um', '7.424um', '7.38um', '7.336um', '7.293um', '7.25um', \
                      '7.208um', '7.166um', '7.125um', '7.085um', '7.044um', '7.005um', '6.965um', '6.926um', '6.888um', '6.85um', '6.812um', '6.775um', '6.738um', '6.702um', '6.595um', '6.491um', \
                      '6.391um', '6.293um', '6.199um', '6.107um', '5.989um', '5.904um', '5.793um', '5.61um', '5.39um', '5.209um', '4.999um', '4.805um', '4.592um', '4.396um', '4.203um', '3.999um', \
                      '3.936um', '3.874um', '3.815um', '3.757um', '3.701um', '3.647um', '3.594um', '3.542um', '3.492um', '3.444um', '3.397um', '3.342um', '3.324um', '3.306um', '3.297um', '3.29um', \
                      '3.28um', '3.246um', '3.204um', '3.099um', '3.002um', '2.8um', '2.661um', '2.512um', '2.371um', '2.239um', '2.113um', '1.995um', '1.884um', '1.778um', '1.679um', '1.585um', \
                      '1.496um', '1.413um', '1.334um', '1.259um', '1.189um', '1.122um', '1.059um', '1.um', '944.1nm', '891.3nm', '841.4nm', '794.3nm', '749.9nm', '707.9nm', '668.3nm', \
                      '631nm', '595.7nm', '562.3nm', '530.9nm', '501.2nm', '473.2nm', '446.7nm', '421.7nm', '398.1nm', '375.8nm', '354.8nm', '335nm', '316.2nm', '298.5nm', \
                      '281.8nm', '266.1nm', '251.2nm', '237.1nm', '223.9nm', '211.3nm', '199.5nm', '188.4nm', '177.8nm', '167.9nm', '158.5nm', '149.6nm', '141.3nm', '133.4nm', \
                      '125.9nm', '121.6nm', '118.9nm', '112.2nm', '105.9nm', '100nm', '94.41nm', '89.13nm', '84.14nm', '79.43nm', '74.99nm', '70.79nm', '66.83nm', \
                      '63.1nm', '59.57nm', '58.4nm', '56.23nm', '53.09nm', '50.12nm', '47.32nm', '44.67nm', '42.17nm', '39.81nm', '37.58nm', '35.48nm', \
                      '33.5nm', '31.62nm', '30.4nm', '29.85nm', '28.18nm', '26.61nm', '25.12nm', '23.71nm', '22.39nm', '19.95nm', '17.78nm', '15.85nm', \
                      '14.13nm', '12.59nm', '11.22nm', '10.6nm', '10nm', '9nm', '8nm', '7nm', '6nm', '5nm', '4nm', '3nm', '2nm', '1nm'])
